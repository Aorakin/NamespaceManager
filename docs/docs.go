    ...
    "paths": {
        "/ns/namespaceUsage/{ns_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Namespace usage data",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "$ref": "#/definitions/dtos.UsageDTO"
                            }
                        }
                    },
                    "500": {
                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "additionalProperties": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/dtos.NamespaceDTO"
                                }
                            }
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "$ref": "#/definitions/dtos.ResourcesPoolDetailDTO"
                            }
                        }
                    },
                    "500": {
        ...
        "/ns/quota/{ns_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Quota data (JSON from clearing house)",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/ticket": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dtos.UserTicketResponse"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Ticket request payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.RequestTicketDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.DeleteTicketsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ticket/getTickets/{namespace_id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/ticket/getTickets/{namespace_id}/{node_id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/ticket/handleticket": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Ticket callback payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.DeleteTasksRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ticket/updateTicketStatusFromGlidelet": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dtos.StatusRes"
                            }
                        }
                    }
                ],
        ...
        "/users/podStatus": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Pod status payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "dtos.CreateTicket": {
            ...
            "properties": {
                ...
                "spec": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.SpecListReq"
                    }
                }
            }
        },
        "dtos.DeleteTasksRequest": {
            "type": "object",
            "required": [
                "task_ids"
            ],
        ...
        "dtos.NamespaceDTO": {
            ...
            "properties": {
                ...
                "namespace_members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.NamespaceMembers"
                    }
                },
                "project_id": {
                    "type": "string"
        ...
        "dtos.RequestTicketDTO": {
            ...
            "properties": {
                ...
                "resources": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_ticket_dtos.ResourceDTO"
                    }
                }
            }
        },
        "dtos.ResourcesPoolDetailDTO": {
            "type": "object",
            "properties": {
                "display_name": {
                    "type": "string"
        ...
        "dtos.SpecListReq": {
            ...
            "properties": {
                ...
                "resource": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.SpecResourceReq"
                    }
                },
                "type": {
                    "$ref": "#/definitions/models.ResourceUnitType"
                }
            }
        },
        "dtos.SpecResourceReq": {
            "type": "object",
            "required": [
                "name",
                "quantity",
        ...
        "dtos.StatusRes": {
            ...
            "properties": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.PodStatus"
                    }
                },
                "ticketId": {
                    "type": "string"
        ...
        "dtos.UsageDTO": {
            ...
            "properties": {
                "usage": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.UsageDetail"
                    }
                }
            }
        },
        ...
        "dtos.UserTicketResponse": {
            ...
            "properties": {
                ...
                "ticket": {
                    "$ref": "#/definitions/models.GliderTicket"
                }
            }
        },
        "internal_ticket_dtos.ResourceDTO": {
            "type": "object",
            "required": [
                "quantity",
                "resource_id"
        ...
        "models.GliderSpec": {
            ...
            "properties": {
                ...
                "resource": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SpecResource"
                    }
                },
                "type": {
                    "$ref": "#/definitions/models.ResourceUnitType"
        ...
        "models.GliderTicket": {
            ...
            "properties": {
                ...
                "glidelet_urn": {
                    "description": "resource_pool.URN (where to send request)",
                    "type": "string"
                },
                "id": {
                    "description": "ticket id",
                ...
                "spec": {
                    "$ref": "#/definitions/models.GliderSpec"
                }
            }
        },
        "models.ResourceUnitType": {
            "type": "string",
            "enum": [
                "compute",
                "compute",
